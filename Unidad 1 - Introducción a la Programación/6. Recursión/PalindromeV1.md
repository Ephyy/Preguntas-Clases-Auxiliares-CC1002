...
1. Cree la función recursiva ```invertir(N)```, que recibe un número entero positivo, y entrega el mismo
...
2. Cree la función ```palindrome(N)```, que recibe un número entero positivo, y entrega True si el número se escribe igual al revés y al derecho, y False en caso contrario. Ejemplos:
