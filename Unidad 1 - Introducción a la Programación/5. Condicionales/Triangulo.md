...
1. Implemente la función ```clasificacion(a, b, c)``` del módulo `triangulos.py` con su receta de diseño completa.

2. Use el módulo `triangulos.py` en el archivo `programa.py`, para implementar un programa interactivo que reproduzca el siguiente diálogo:
