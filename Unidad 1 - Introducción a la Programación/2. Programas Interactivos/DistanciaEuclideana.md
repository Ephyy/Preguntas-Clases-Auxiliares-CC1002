...
1. Siguiendo la receta de diseño, implemente la función llamada ```distancia(x1, y1, x2, y2)```, la cual recibe dos puntos en el plano euclideano $(𝑥_{1}, 𝑦_{1})$ y $(𝑥_{2}, 𝑦_{2})$ y retorna la distancia entre ellos ocupando la fórmula.
