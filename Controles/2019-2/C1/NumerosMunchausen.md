...
**a)** Un número de Munchausen es un entero positivo que es igual a la suma de todos sus dígitos elevados a los mismos dígitos. Por ejemplo, 3435 es un número de Munchausen, puesto que la suma $3^3 + 4^4 + 3^3 + 5^5$ es igual a 3435. Asimismo, 1 es también un número de Munchausen, puesto que $1^1 = 1$
